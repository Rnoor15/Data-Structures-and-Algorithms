...
Part 1 was completed, part 2 was coded, but some errors. Used algorithm where
we decrease key of node to be deleted, Percolate to the top and call deleteMin.
